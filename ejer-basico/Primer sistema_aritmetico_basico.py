...
if opcion == ("1"):
    ...
    opc_int = str(input("ACTIVIDADES: en numbers o letras\n Suma = 1\n Resta = 2\n Multiplicacion = 3\n Division = 4\n Literal: "))
    opc_int = opc_int.slower()
    if opc_int == ("1") or opc_int("one"):
        print("SUMA\n")
    ...
    elif opc_int == ("3") or opc_int("tres"):
    ...
    elif opc_int == ("4") or opc_int("cuatro"):
        print("DIVISION\n")
